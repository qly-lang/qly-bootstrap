...
(test parse-uint
  ...
  (uint-type-test 0 16 :u32)
  (uint-type-test 0 8 :u32)
  (uint-type-test 0 2 :u32)
  (uint-type-test (1- (expt 2 32)) 16 :u32)
  (uint-type-test (expt 2 32) 16 :u64)
  (uint-type-test (1- (expt 2 64)) 8 :u64)
  (uint-type-test (expt 2 64) 8 :u128)
  (uint-type-test (1- (expt 2 128)) 2 :u128)
